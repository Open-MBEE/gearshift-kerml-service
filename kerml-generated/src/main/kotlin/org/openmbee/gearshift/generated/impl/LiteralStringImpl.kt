...
/**
 * Implementation of LiteralString.
 * A LiteralString is a LiteralExpression that provides a String value as a result.
 */
open class LiteralStringImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : LiteralExpressionImpl(className, metaClass, engine), LiteralString {

    /**
     * Create a new LiteralString instance.
    ...
    constructor(
    ...
    ) : this("LiteralString", engine.schema.getClass("LiteralString")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "LiteralString")
            if (resolved != null) {
