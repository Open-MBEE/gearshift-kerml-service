...
open class FeatureChainingImpl(
    ...
    engine: MDMEngine
) : RelationshipImpl(className, metaClass, engine), FeatureChaining {

    /**
     * Create a new FeatureChaining instance.
    ...
    constructor(
    ...
    ) : this("FeatureChaining", engine.schema.getClass("FeatureChaining")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "FeatureChaining")
            if (resolved != null) {
    ...
    override var chainingFeature: Feature
        ...
        set(value) {
            engine.setProperty(id!!, "chainingFeature", value)
        }

    override val featureChained: Feature
        get() {
            val rawValue = engine.getProperty(id!!, "featureChained")
            return rawValue as Feature
        }

    override val featureTarget: Feature
        get() {
            val rawValue = engine.getProperty(id!!, "featureTarget")
            return rawValue as Feature
        }
}
