 ...
 */
open class ClassImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : ClassifierImpl(className, metaClass, engine), Class {
    ...
    constructor(
    ...
    ) : this("Class", engine.schema.getClass("Class")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Class")
            if (resolved != null) {
