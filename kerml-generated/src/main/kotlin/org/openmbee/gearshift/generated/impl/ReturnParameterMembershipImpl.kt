...
open class ReturnParameterMembershipImpl(
    ...
    engine: MDMEngine
) : ParameterMembershipImpl(className, metaClass, engine), ReturnParameterMembership {

    /**
     * Create a new ReturnParameterMembership instance.
    ...
    constructor(
    ...
    ) : this("ReturnParameterMembership", engine.schema.getClass("ReturnParameterMembership")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "ReturnParameterMembership")
            if (resolved != null) {
