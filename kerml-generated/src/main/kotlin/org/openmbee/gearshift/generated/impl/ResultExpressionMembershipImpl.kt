...
open class ResultExpressionMembershipImpl(
    ...
    engine: MDMEngine
) : FeatureMembershipImpl(className, metaClass, engine), ResultExpressionMembership {

    /**
     * Create a new ResultExpressionMembership instance.
    ...
    constructor(
    ...
    ) : this("ResultExpressionMembership", engine.schema.getClass("ResultExpressionMembership")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "ResultExpressionMembership")
            if (resolved != null) {
