...
open class ParameterMembershipImpl(
    ...
    engine: MDMEngine
) : FeatureMembershipImpl(className, metaClass, engine), ParameterMembership {

    /**
     * Create a new ParameterMembership instance.
    ...
    constructor(
    ...
    ) : this("ParameterMembership", engine.schema.getClass("ParameterMembership")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "ParameterMembership")
            if (resolved != null) {
    ...
    override val ownedMemberParameter: Feature
        get() {
            val rawValue = engine.getProperty(id!!, "ownedMemberParameter")
            return rawValue as Feature
        }

    override fun parameterDirection(): String? {
        val result = engine.invokeOperation(id!!, "parameterDirection")
