...
/**
 * Implementation of CollectExpression.
 ...
 */
open class CollectExpressionImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : OperatorExpressionImpl(className, metaClass, engine), CollectExpression {

    /**
     * Create a new CollectExpression instance.
    ...
    constructor(
    ...
    ) : this("CollectExpression", engine.schema.getClass("CollectExpression")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "CollectExpression")
            if (resolved != null) {
