...
/**
 * Implementation of ViewRenderingMembership.
 * A FeatureMembership that identifies the Rendering of a View
 */
open class ViewRenderingMembershipImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : FeatureMembershipImpl(className, metaClass, engine), ViewRenderingMembership {

    /**
     * Create a new ViewRenderingMembership instance.
    ...
    constructor(
    ...
    ) : this("ViewRenderingMembership", engine.schema.getClass("ViewRenderingMembership")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "ViewRenderingMembership")
            if (resolved != null) {
