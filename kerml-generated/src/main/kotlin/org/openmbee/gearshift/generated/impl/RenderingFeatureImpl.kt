...
open class RenderingFeatureImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : FeatureImpl(className, metaClass, engine), RenderingFeature {

    /**
     * Create a new RenderingFeature instance.
    ...
    constructor(
    ...
    ) : this("RenderingFeature", engine.schema.getClass("RenderingFeature")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "RenderingFeature")
            if (resolved != null) {
