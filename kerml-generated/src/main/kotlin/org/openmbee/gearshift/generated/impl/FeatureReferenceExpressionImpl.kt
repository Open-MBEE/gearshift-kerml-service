...
/**
 * Implementation of FeatureReferenceExpression.
 * A FeatureReferenceExpression is an Expression whose result is bound to a referent Feature.
 */
open class FeatureReferenceExpressionImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : ExpressionImpl(className, metaClass, engine), FeatureReferenceExpression {

    /**
     * Create a new FeatureReferenceExpression instance.
    ...
    constructor(
    ...
    ) : this("FeatureReferenceExpression", engine.schema.getClass("FeatureReferenceExpression")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "FeatureReferenceExpression")
            if (resolved != null) {
