...
open class FeatureMembershipImpl(
    ...
    engine: MDMEngine
) : OwningMembershipImpl(className, metaClass, engine), FeatureMembership {

    /**
     * Create a new FeatureMembership instance.
    ...
    constructor(
    ...
    ) : this("FeatureMembership", engine.schema.getClass("FeatureMembership")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "FeatureMembership")
            if (resolved != null) {
