...
/**
 * Implementation of LiteralBoolean.
 * LiteralBoolean is a LiteralExpression that provides a Boolean value as a result.
 */
open class LiteralBooleanImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : LiteralExpressionImpl(className, metaClass, engine), LiteralBoolean {

    /**
     * Create a new LiteralBoolean instance.
    ...
    constructor(
    ...
    ) : this("LiteralBoolean", engine.schema.getClass("LiteralBoolean")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "LiteralBoolean")
            if (resolved != null) {
