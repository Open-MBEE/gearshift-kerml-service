...
open class NamespaceImportImpl(
    ...
    engine: MDMEngine
) : ImportImpl(className, metaClass, engine), NamespaceImport {

    /**
     * Create a new NamespaceImport instance.
    ...
    constructor(
    ...
    ) : this("NamespaceImport", engine.schema.getClass("NamespaceImport")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "NamespaceImport")
            if (resolved != null) {
