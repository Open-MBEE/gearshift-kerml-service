...
open class MembershipExposeImpl(
    className: String,
    ...
    constructor(
    ...
    ) : this("MembershipExpose", engine.schema.getClass("MembershipExpose")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "MembershipExpose")
            if (resolved != null) {
