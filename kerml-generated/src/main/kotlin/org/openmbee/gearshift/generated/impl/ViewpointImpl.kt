 ...
 */
open class ViewpointImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : PredicateImpl(className, metaClass, engine), Viewpoint {

    /**
     * Create a new Viewpoint instance.
    ...
    constructor(
    ...
    ) : this("Viewpoint", engine.schema.getClass("Viewpoint")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Viewpoint")
            if (resolved != null) {
