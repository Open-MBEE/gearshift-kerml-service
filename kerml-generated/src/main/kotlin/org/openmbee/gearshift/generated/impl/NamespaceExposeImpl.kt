...
open class NamespaceExposeImpl(
    className: String,
    ...
    constructor(
    ...
    ) : this("NamespaceExpose", engine.schema.getClass("NamespaceExpose")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "NamespaceExpose")
            if (resolved != null) {
