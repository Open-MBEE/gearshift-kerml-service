 ...
 */
open class DocumentationImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : CommentImpl(className, metaClass, engine), Documentation {
    ...
    constructor(
    ...
    ) : this("Documentation", engine.schema.getClass("Documentation")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Documentation")
            if (resolved != null) {
    ...
    override val documentedElement: Element
        get() {
            val rawValue = engine.getProperty(id!!, "documentedElement")
