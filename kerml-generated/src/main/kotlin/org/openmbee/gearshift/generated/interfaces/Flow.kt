 ...
 */
interface Flow : Step, Connector {

    val flowEnd: List<FlowEnd>

    val interaction: List<Interaction>

    val payloadFeature: PayloadFeature?

    val payloadType: List<Classifier>

    val sourceOutputFeature: Feature?

    val targetInputFeature: Feature?
}
