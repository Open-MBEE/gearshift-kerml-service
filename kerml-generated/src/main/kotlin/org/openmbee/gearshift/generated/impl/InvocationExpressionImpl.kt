...
open class InvocationExpressionImpl(
    ...
    engine: MDMEngine
) : InstantiationExpressionImpl(className, metaClass, engine), InvocationExpression {

    /**
     * Create a new InvocationExpression instance.
    ...
    constructor(
    ...
    ) : this("InvocationExpression", engine.schema.getClass("InvocationExpression")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "InvocationExpression")
            if (resolved != null) {
