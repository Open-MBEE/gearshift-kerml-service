...
open class SpecializationImpl(
    ...
    engine: MDMEngine
) : RelationshipImpl(className, metaClass, engine), Specialization {
    ...
    constructor(
    ...
    ) : this("Specialization", engine.schema.getClass("Specialization")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Specialization")
            if (resolved != null) {
    ...
    override var general: Type
        get() {
            val rawValue = engine.getProperty(id!!, "general")
            return rawValue as Type
        }
        set(value) {
            engine.setProperty(id!!, "general", value)
        }
    ...
    override var specific: Type
        get() {
            val rawValue = engine.getProperty(id!!, "specific")
            return rawValue as Type
        }
        set(value) {
            engine.setProperty(id!!, "specific", value)
        }
}
