...
open class MetadataAccessExpressionImpl(
    ...
    engine: MDMEngine
) : ExpressionImpl(className, metaClass, engine), MetadataAccessExpression {

    /**
     * Create a new MetadataAccessExpression instance.
    ...
    constructor(
    ...
    ) : this("MetadataAccessExpression", engine.schema.getClass("MetadataAccessExpression")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "MetadataAccessExpression")
            if (resolved != null) {
    ...
    override val referencedElement: Element
        get() {
            val rawValue = engine.getProperty(id!!, "referencedElement")
    ...
    override fun metaclassFeature(metaclass: Metaclass): Feature? {
        val result = engine.invokeOperation(id!!, "metaclassFeature", mapOf("metaclass" to metaclass))
