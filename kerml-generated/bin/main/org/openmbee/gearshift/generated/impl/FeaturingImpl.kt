...
/**
 * Implementation of Featuring.
 * A relationship that features a type with features
 */
open class FeaturingImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : RelationshipImpl(className, metaClass, engine), Featuring {

    /**
     * Create a new Featuring instance.
    ...
    constructor(
    ...
    ) : this("Featuring", engine.schema.getClass("Featuring")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Featuring")
            if (resolved != null) {
