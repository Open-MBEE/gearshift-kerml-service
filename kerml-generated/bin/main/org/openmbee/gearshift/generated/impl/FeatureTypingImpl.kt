...
open class FeatureTypingImpl(
    ...
    engine: MDMEngine
) : SpecializationImpl(className, metaClass, engine), FeatureTyping {

    /**
     * Create a new FeatureTyping instance.
    ...
    constructor(
    ...
    ) : this("FeatureTyping", engine.schema.getClass("FeatureTyping")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "FeatureTyping")
            if (resolved != null) {
    ...
    override var type: Type
        ...
        set(value) {
            engine.setProperty(id!!, "type", value)
        }

    override var typedFeature: Feature
        get() {
            val rawValue = engine.getProperty(id!!, "typedFeature")
            return rawValue as Feature
        }
        set(value) {
            engine.setProperty(id!!, "typedFeature", value)
        }
}
