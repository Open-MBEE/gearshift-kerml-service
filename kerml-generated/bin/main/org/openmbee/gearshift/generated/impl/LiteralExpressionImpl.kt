...
open class LiteralExpressionImpl(
    ...
    engine: MDMEngine
) : ExpressionImpl(className, metaClass, engine), LiteralExpression {

    /**
     * Create a new LiteralExpression instance.
    ...
    constructor(
    ...
    ) : this("LiteralExpression", engine.schema.getClass("LiteralExpression")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "LiteralExpression")
            if (resolved != null) {
