 ...
 */
open class DataTypeImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : ClassifierImpl(className, metaClass, engine), DataType {
    ...
    constructor(
    ...
    ) : this("DataType", engine.schema.getClass("DataType")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "DataType")
            if (resolved != null) {
