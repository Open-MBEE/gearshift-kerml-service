...
/**
 * Implementation of LiteralInfinity.
 * A LiteralInfinity is a LiteralExpression that provides the positive infinity value (*).
 */
open class LiteralInfinityImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : LiteralExpressionImpl(className, metaClass, engine), LiteralInfinity {

    /**
     * Create a new LiteralInfinity instance.
    ...
    constructor(
    ...
    ) : this("LiteralInfinity", engine.schema.getClass("LiteralInfinity")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "LiteralInfinity")
            if (resolved != null) {
