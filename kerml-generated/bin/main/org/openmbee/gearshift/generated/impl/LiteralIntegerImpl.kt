...
/**
 * Implementation of LiteralInteger.
 * A LiteralInteger is a LiteralExpression that provides an Integer value as a result.
 */
open class LiteralIntegerImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : LiteralExpressionImpl(className, metaClass, engine), LiteralInteger {

    /**
     * Create a new LiteralInteger instance.
    ...
    constructor(
    ...
    ) : this("LiteralInteger", engine.schema.getClass("LiteralInteger")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "LiteralInteger")
            if (resolved != null) {
