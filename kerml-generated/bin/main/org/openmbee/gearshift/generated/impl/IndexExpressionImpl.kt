...
/**
 * Implementation of IndexExpression.
 ...
 */
open class IndexExpressionImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : OperatorExpressionImpl(className, metaClass, engine), IndexExpression {
    ...
    constructor(
    ...
    ) : this("IndexExpression", engine.schema.getClass("IndexExpression")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "IndexExpression")
            if (resolved != null) {
