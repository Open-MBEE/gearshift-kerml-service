...
open class UnioningImpl(
    ...
    engine: MDMEngine
) : RelationshipImpl(className, metaClass, engine), Unioning {

    /**
     * Create a new Unioning instance.
    ...
    constructor(
    ...
    ) : this("Unioning", engine.schema.getClass("Unioning")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Unioning")
            if (resolved != null) {
    ...
    override val typeUnioned: Type?
        get() {
            val rawValue = engine.getProperty(id!!, "typeUnioned")
    ...
    override var unioningType: Type
        ...
        set(value) {
            engine.setProperty(id!!, "unioningType", value)
        }
}
