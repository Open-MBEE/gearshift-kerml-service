...
open class MembershipImportImpl(
    ...
    engine: MDMEngine
) : ImportImpl(className, metaClass, engine), MembershipImport {

    /**
     * Create a new MembershipImport instance.
    ...
    constructor(
    ...
    ) : this("MembershipImport", engine.schema.getClass("MembershipImport")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "MembershipImport")
            if (resolved != null) {
