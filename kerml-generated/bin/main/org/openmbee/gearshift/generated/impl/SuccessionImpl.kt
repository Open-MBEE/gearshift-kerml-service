...
open class SuccessionImpl(
    ...
    engine: MDMEngine
) : ConnectorImpl(className, metaClass, engine), Succession {

    /**
     * Create a new Succession instance.
    ...
    constructor(
    ...
    ) : this("Succession", engine.schema.getClass("Succession")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Succession")
            if (resolved != null) {
