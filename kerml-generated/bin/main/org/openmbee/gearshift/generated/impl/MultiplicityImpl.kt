 ...
 */
open class MultiplicityImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : FeatureImpl(className, metaClass, engine), Multiplicity {

    /**
     * Create a new Multiplicity instance.
    ...
    constructor(
    ...
    ) : this("Multiplicity", engine.schema.getClass("Multiplicity")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Multiplicity")
            if (resolved != null) {
