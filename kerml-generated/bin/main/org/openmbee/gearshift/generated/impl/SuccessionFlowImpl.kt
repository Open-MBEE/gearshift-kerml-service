...
open class SuccessionFlowImpl(
    ...
    engine: MDMEngine
) : FlowImpl(className, metaClass, engine), SuccessionFlow {

    /**
     * Create a new SuccessionFlow instance.
    ...
    constructor(
    ...
    ) : this("SuccessionFlow", engine.schema.getClass("SuccessionFlow")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "SuccessionFlow")
            if (resolved != null) {
