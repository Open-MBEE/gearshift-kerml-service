...
open class InteractionImpl(
    ...
    engine: MDMEngine
) : BehaviorImpl(className, metaClass, engine), Interaction {
    ...
    constructor(
    ...
    ) : this("Interaction", engine.schema.getClass("Interaction")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Interaction")
            if (resolved != null) {
