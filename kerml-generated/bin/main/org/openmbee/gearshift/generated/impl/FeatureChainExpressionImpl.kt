...
open class FeatureChainExpressionImpl(
    ...
    engine: MDMEngine
) : OperatorExpressionImpl(className, metaClass, engine), FeatureChainExpression {

    /**
     * Create a new FeatureChainExpression instance.
    ...
    constructor(
    ...
    ) : this("FeatureChainExpression", engine.schema.getClass("FeatureChainExpression")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "FeatureChainExpression")
            if (resolved != null) {
    ...
    override fun sourceTargetFeature(): Feature? {
        val result = engine.invokeOperation(id!!, "sourceTargetFeature")
