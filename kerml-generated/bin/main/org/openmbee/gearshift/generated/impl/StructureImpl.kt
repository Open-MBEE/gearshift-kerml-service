 ...
 */
open class StructureImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : ClassImpl(className, metaClass, engine), Structure {
    ...
    constructor(
    ...
    ) : this("Structure", engine.schema.getClass("Structure")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Structure")
            if (resolved != null) {
