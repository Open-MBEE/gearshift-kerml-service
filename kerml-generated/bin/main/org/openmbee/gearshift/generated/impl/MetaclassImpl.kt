 ...
 */
open class MetaclassImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : StructureImpl(className, metaClass, engine), Metaclass {
    ...
    constructor(
    ...
    ) : this("Metaclass", engine.schema.getClass("Metaclass")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Metaclass")
            if (resolved != null) {
