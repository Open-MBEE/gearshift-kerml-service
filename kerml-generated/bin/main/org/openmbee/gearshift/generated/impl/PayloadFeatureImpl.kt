...
/**
 * Implementation of PayloadFeature.
 ...
 */
open class PayloadFeatureImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : FeatureImpl(className, metaClass, engine), PayloadFeature {

    /**
     * Create a new PayloadFeature instance.
    ...
    constructor(
    ...
    ) : this("PayloadFeature", engine.schema.getClass("PayloadFeature")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "PayloadFeature")
            if (resolved != null) {
