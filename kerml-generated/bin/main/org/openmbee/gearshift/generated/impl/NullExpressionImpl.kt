...
open class NullExpressionImpl(
    ...
    engine: MDMEngine
) : ExpressionImpl(className, metaClass, engine), NullExpression {
    ...
    constructor(
    ...
    ) : this("NullExpression", engine.schema.getClass("NullExpression")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "NullExpression")
            if (resolved != null) {
