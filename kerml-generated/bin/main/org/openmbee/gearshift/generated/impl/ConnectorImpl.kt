...
open class ConnectorImpl(
    ...
    engine: MDMEngine
) : FeatureImpl(className, metaClass, engine), Connector {
    ...
    constructor(
    ...
    ) : this("Connector", engine.schema.getClass("Connector")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Connector")
            if (resolved != null) {
