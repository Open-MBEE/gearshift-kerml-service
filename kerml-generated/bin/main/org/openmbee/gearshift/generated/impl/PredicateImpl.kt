 ...
 */
open class PredicateImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : FunctionImpl(className, metaClass, engine), Predicate {
    ...
    constructor(
    ...
    ) : this("Predicate", engine.schema.getClass("Predicate")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Predicate")
            if (resolved != null) {
