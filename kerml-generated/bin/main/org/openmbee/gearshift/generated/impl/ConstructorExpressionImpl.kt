...
open class ConstructorExpressionImpl(
    ...
    engine: MDMEngine
) : InstantiationExpressionImpl(className, metaClass, engine), ConstructorExpression {

    /**
     * Create a new ConstructorExpression instance.
    ...
    constructor(
    ...
    ) : this("ConstructorExpression", engine.schema.getClass("ConstructorExpression")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "ConstructorExpression")
            if (resolved != null) {
