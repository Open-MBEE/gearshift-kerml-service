...
open class ConjugationImpl(
    ...
    engine: MDMEngine
) : RelationshipImpl(className, metaClass, engine), Conjugation {

    /**
     * Create a new Conjugation instance.
    ...
    constructor(
    ...
    ) : this("Conjugation", engine.schema.getClass("Conjugation")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "Conjugation")
            if (resolved != null) {
    ...
    override var conjugatedType: Type
        get() {
            val rawValue = engine.getProperty(id!!, "conjugatedType")
            return rawValue as Type
        }
        set(value) {
            engine.setProperty(id!!, "conjugatedType", value)
        }

    override var originalType: Type
        get() {
            val rawValue = engine.getProperty(id!!, "originalType")
            return rawValue as Type
        }
        set(value) {
            engine.setProperty(id!!, "originalType", value)
        }
