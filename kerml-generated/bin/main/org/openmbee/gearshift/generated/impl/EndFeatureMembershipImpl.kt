...
/**
 * Implementation of EndFeatureMembership.
 * A FeatureMembership that identifies a Feature as an endFeature of a Type
 */
open class EndFeatureMembershipImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : FeatureMembershipImpl(className, metaClass, engine), EndFeatureMembership {

    /**
     * Create a new EndFeatureMembership instance.
    ...
    constructor(
    ...
    ) : this("EndFeatureMembership", engine.schema.getClass("EndFeatureMembership")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "EndFeatureMembership")
            if (resolved != null) {
    ...
    override val ownedMemberFeature: Feature
        get() {
            val rawValue = engine.getProperty(id!!, "ownedMemberFeature")
