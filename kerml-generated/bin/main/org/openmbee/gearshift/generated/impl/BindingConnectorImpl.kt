...
/**
 * Implementation of BindingConnector.
 * A connector that binds features together
 */
open class BindingConnectorImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : ConnectorImpl(className, metaClass, engine), BindingConnector {

    /**
     * Create a new BindingConnector instance.
    ...
    constructor(
    ...
    ) : this("BindingConnector", engine.schema.getClass("BindingConnector")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "BindingConnector")
            if (resolved != null) {
