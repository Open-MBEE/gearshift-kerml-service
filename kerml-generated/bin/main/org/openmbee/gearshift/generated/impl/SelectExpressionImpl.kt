...
/**
 * Implementation of SelectExpression.
 ...
 */
open class SelectExpressionImpl(
    className: String,
    metaClass: FrameworkMetaClass,
    engine: MDMEngine
) : OperatorExpressionImpl(className, metaClass, engine), SelectExpression {

    /**
     * Create a new SelectExpression instance.
    ...
    constructor(
    ...
    ) : this("SelectExpression", engine.schema.getClass("SelectExpression")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "SelectExpression")
            if (resolved != null) {
