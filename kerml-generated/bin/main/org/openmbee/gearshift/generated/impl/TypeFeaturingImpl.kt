...
open class TypeFeaturingImpl(
    ...
    engine: MDMEngine
) : FeaturingImpl(className, metaClass, engine), TypeFeaturing {

    /**
     * Create a new TypeFeaturing instance.
    ...
    constructor(
    ...
    ) : this("TypeFeaturing", engine.schema.getClass("TypeFeaturing")!!, engine) {
        ...
        parent?.let { owner ->
            ...
            val resolved = resolver.resolve(owner.className, "TypeFeaturing")
            if (resolved != null) {
    ...
    override var featureOfType: Feature
        get() {
            val rawValue = engine.getProperty(id!!, "featureOfType")
            return rawValue as Feature
        }
        set(value) {
            engine.setProperty(id!!, "featureOfType", value)
        }
    ...
    override var featuringType: Type
        ...
        set(value) {
            engine.setProperty(id!!, "featuringType", value)
        }

    override val owningFeatureOfType: Feature?
        get() {
            val rawValue = engine.getProperty(id!!, "owningFeatureOfType")
            return rawValue as? Feature
        }
}
