    ...
    describe("Polymorphic constraint resolution (redefines)") {
        ...
        it("should use redefining constraint from subclass for derived property") {
            ...
            registry.registerClass(MetaClass(
                ...
                constraints = listOf(
                    org.openmbee.gearshift.framework.meta.MetaConstraint(
                        name = "deriveBaseClassDerivedValue",
                        type = org.openmbee.gearshift.framework.meta.ConstraintType.DERIVATION,
                        expression = "null",
            ...
            registry.registerClass(MetaClass(
                ...
                constraints = listOf(
                    org.openmbee.gearshift.framework.meta.MetaConstraint(
                        ...
                        type = org.openmbee.gearshift.framework.meta.ConstraintType.VERIFICATION,
