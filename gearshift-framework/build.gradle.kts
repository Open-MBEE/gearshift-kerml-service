...
tasks.named<AntlrTask>("generateGrammarSource") {
    ...
    arguments = arguments + listOf(
        "-visitor",
        "-package", "org.openmbee.gearshift.framework.constraints.ocl.antlr"
    )
    outputDirectory = file("${project.buildDir}/generated-src/antlr/main/org/openmbee/gearshift/framework/constraints/ocl/antlr")
}
