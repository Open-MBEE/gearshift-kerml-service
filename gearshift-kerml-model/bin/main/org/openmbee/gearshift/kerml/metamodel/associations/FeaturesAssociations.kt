...
fun createFeaturesAssociations(): List<MetaAssociation> {
    ...
    val owningFeatureOfTypeOwnedTypeFeaturingAssociation = MetaAssociation(
        ...
        sourceEnd = MetaAssociationEnd(
            ...
            derivationConstraint = "deriveTypeFeaturingOwningFeatureOfType"
        ),
        targetEnd = MetaAssociationEnd(
    ...
    val owningFeatureOwnedTypingAssociation = MetaAssociation(
        ...
        sourceEnd = MetaAssociationEnd(
            ...
            derivationConstraint = "deriveFeatureTypingOwningFeature"
        ),
        targetEnd = MetaAssociationEnd(
            name = "ownedTyping",
            type = "FeatureTyping",
    ...
    val featureOfTypeFeaturingTypeAssociation = MetaAssociation(
        ...
        sourceEnd = MetaAssociationEnd(
            ...
            isDerived = true,
            isNavigable = false,
            derivationConstraint = "computeFeatureFeatureOfType"
        ),
        targetEnd = MetaAssociationEnd(
            name = "featuringType",
            type = "Type",
    ...
    val typedFeatureTypeAssociation = MetaAssociation(
        ...
        sourceEnd = MetaAssociationEnd(
            ...
            isDerived = true,
            isNavigable = false,
            derivationConstraint = "computeFeatureTypedFeature"
        ),
        targetEnd = MetaAssociationEnd(
            name = "type",
            type = "Type",
