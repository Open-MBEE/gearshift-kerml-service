 ...
 *
 * Note: The implied Subsetting from result to referent (checkFeatureReferenceExpressionResultSpecialization)
 * requires semantic binding support for sub-element relationships, which is not yet implemented.
 */
