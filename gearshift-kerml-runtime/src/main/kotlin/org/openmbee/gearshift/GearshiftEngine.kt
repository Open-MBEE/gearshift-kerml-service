...
import org.openmbee.gearshift.framework.storage.QueryEngine
...
class GearshiftEngine {
    ...
    fun evaluateOclAst(
        instance: MDMObject,
        ast: org.openmbee.gearshift.framework.constraints.ocl.OclExpression
    ): Any? {
...
data class GearshiftStatistics(
    val objects: org.openmbee.gearshift.framework.storage.RepositoryStatistics,
    val links: org.openmbee.gearshift.framework.storage.LinkRepositoryStatistics
)
