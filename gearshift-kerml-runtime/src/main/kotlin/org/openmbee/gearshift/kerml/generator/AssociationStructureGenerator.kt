...
class AssociationStructureGenerator : BaseClassifierGenerator<AssociationStructure>() {

    override fun generate(element: AssociationStructure, context: GenerationContext): String = buildString {
