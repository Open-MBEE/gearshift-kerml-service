...
class ExpressionContainerGenerator : BaseFeatureGenerator<Expression>() {

    override fun generate(element: Expression, context: GenerationContext): String = buildString {
