...
public class KerMLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"REGULAR_COMMENT", "UNRESTRICTED_NAME", "BASIC_INITIAL_CHARACTER", "BASIC_NAME_CHARACTER", 
			"ALPHABETIC_CHARACTER", "DECIMAL_DIGIT", "NAME_CHARACTER", "ESCAPE_SEQUENCE", 
			"DECIMAL_VALUE", "EXPONENTIAL_VALUE", "STRING_VALUE", "STRING_CHARACTER", 
			"BASIC_NAME", "NAME", "WS"
		};
	}
	...
	public KerMLLexer(CharStream input) {
		super(input);
