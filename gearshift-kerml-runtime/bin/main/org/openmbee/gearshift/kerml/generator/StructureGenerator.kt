...
/**
 * Generator for Structure elements.
 *
 * Per KerML spec: Structures are classifiers that classify structured values.
 *
 * Grammar:
 * ```
 * structure
 ...
 * ```
 */
class StructureGenerator : BaseClassifierGenerator<Structure>() {

    override fun generate(element: Structure, context: GenerationContext): String = buildString {
