...
data class MDMLink(
    ...
    val isTargetComposite: Boolean
        get() = association.targetEnd.aggregation == org.openmbee.gearshift.metamodel.AggregationKind.COMPOSITE

    /**
     * Check if the source end has composite aggregation (source is part of target).
     */
    val isSourceComposite: Boolean
        get() = association.sourceEnd.aggregation == org.openmbee.gearshift.metamodel.AggregationKind.COMPOSITE
